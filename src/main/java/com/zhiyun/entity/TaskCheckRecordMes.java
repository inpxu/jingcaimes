...
public class TaskCheckRecordMes extends BaseEntity<Long> {
	...
	private static final long serialVersionUID = 2091589900575084516L;
	...
	// 客户是否通过
	@Pattern(regexp="[\\s\\S]{0,1}", message="客户是否通过字段过长")
	private String cusIsOk;
	// 检查人
	@Pattern(regexp="[\\s\\S]{0,30}", message="检查人字段过长")
	private String checkEmpNo;
	// 检查日期
	private java.util.Date checkDate;
	// 描述
	@Pattern(regexp="[\\s\\S]{0,50}", message="描述字段过长")
	private String desc;
	// 
