 ...
 * @date
 */
public class ProdOutDetailIos extends BaseEntity<Long> {

	private static final long serialVersionUID = 6405212861828179439L;
	...
	private String unit;
	// 是否配件
	@Pattern(regexp="[\\s\\S]{0,2}", message="是否配件字段过长")
