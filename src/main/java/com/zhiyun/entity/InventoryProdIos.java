 ...
 * @date
 */
public class InventoryProdIos extends BaseEntity<Long> {

	private static final long serialVersionUID = 2671914329996189812L;
	...
	// 表显数量
	@Pattern(regexp="[\\s\\S]{0,255}", message="表显数量字段过长")
