...
<link rel=stylesheet href="/jingcaimes/static/webuploader.css">
<script src="/jingcaimes/static/jquery-3.2.1.min.js"></script>
<script src="/jingcaimes/static/webuploader.js"></script>
<body>
<div id=app>
    <app ports=http://192.168.0.118:8888/jingcaimes user-name=沈建飞 user-img=http://124.160.96.135:8070/appSign/head.png company-name=飞戎科技有限公司
...
<script type=text/javascript src="/jingcaimes/static/js/manifest.js"></script>
<script type=text/javascript src="/jingcaimes/static/js/vendor.js"></script>
<script type=text/javascript src="/jingcaimes/static/js/app.js"></script>
</body>
</html>